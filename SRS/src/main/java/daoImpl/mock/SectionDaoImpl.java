...
public class SectionDaoImpl implements SectionDao {
	...
	ScheduleOfClasses scheduleOfClasses1 = new ScheduleOfClasses("SP2005-1");
	ScheduleOfClasses scheduleOfClasses2 = new ScheduleOfClasses("SP2005-2");

	public SectionDaoImpl() {
		sections = new HashMap<String, Section>();
		allCourses = new CourseDaoImpl().findAll();
